...
module.exports.run = async function ({ api, event, args }) {
  try {
    ...
    // ✅ Bangla Font Add (NEW)
    registerFont(
      path.join(__dirname, "cache", "NotoSansBengali-Regular.ttf"),
      { family: "Bangla" }
    );
    ...
    // ✅ Bangla Font Use (UPDATED)
    ctx.font = "bold 30px Bangla";
    ctx.fillText("USER ID CARD", 300, 70);

    ctx.font = "22px Bangla";
    ...
    ctx.font = "18px Bangla";
    ctx.fillText("Powered by Sujon", 520, 400);
