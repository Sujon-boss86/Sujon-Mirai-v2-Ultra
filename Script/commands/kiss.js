...
module.exports.onLoad = async () => {
  ...
  if (!_0x4385e1(_0x57f163)) {
    await _0x3435b0("https://i.postimg.cc/QN7pQB81/IMG-20260123-235035.jpg", _0x57f163);
  }
};
async function makeImage({
  ...
  _0x37ab03.resize(700, 440).composite(_0x18b398.resize(120, 120), 400, 30).composite(_0x4c1919.resize(150, 150), 170, 60);
